...
namespace PanelGradient
{
    public class PanelGradient:Panel
    {
        ...
        protected Border3DStyle b3dstyle = Border3DStyle.Adjust;
        #endregion
        ...
        [
        DefaultValue(typeof(Border3DStyle), "Adjust"), Description("BorderStyle"),Category("Appearance"),
        ]
